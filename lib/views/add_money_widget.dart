...
class AddMoneyToWallet extends StatelessWidget {
  ...
  //todo: do not initialize controllers inside widgets that created those widgets
  //final HomePageController homePageController = Get.find();
  /*final SleekSliderController sliderController =
      Get.put(SleekSliderController());*/
  ...
  Widget build(BuildContext context) {
    ...
    final SleekSliderController sliderController =
        Get.put(SleekSliderController());
    final format = NumberFormat.currency(locale: 'HI', symbol: "\u{20B9}");
    return GestureDetector(
      onTap: () {
        print("ontap add money");
        homePageController.removeAboveStackItem(0, context);
      },
      child: Container(
          height: 500,
                          ...
                          children: [
                            ...
                            Obx(
                              () => SleekCircularSlider(
                                ...
                                max: 500000,
                                initialValue:
                                    sliderController.initialSliderValue.value,
                                onChange: (value) {
